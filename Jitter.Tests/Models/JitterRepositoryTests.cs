...
namespace Jitter.Tests.Models
{
    ...
    public class JitterRepositoryTests
    {
        ...
        [TestMethod]
        public void JitterRepositoryGetAllJots()
        {
            ...
            List<Jot> expected_jots = new List<Jot>
            {
                ...
                new Jot {Content="Pumpkin Pie is the best", Date = base_time.AddHours(-1)},
            };
        ...
        [TestMethod]
        public void JitterRepositoryCanCreateAJot()
        {
            List<Jot> expected_jots = new List<Jot>();
            ConnectMocksToDataStore(expected_jots);
            JitterUser a_jitter_user = new JitterUser { Handle = "Popeye1" };
            string content = "Hello Jitter World!";
            mock_jot_set.Setup(j => j.Add(It.IsAny<Jot>())).Callback((Jot s) => expected_jots.Add(s));
            bool success = repository.CreateJot(a_jitter_user, content);
